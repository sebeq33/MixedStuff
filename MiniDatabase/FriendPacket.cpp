...
// Last update Sun Jun  2 12:00:49 2013 sebastien bequignon
//

#include "DataBase/FriendPacket.hh"
...
void FriendPacket::setErase(bool val)
{
  this->erased = val;
}
