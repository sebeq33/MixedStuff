...
** Last update Thu Nov 15 20:02:00 2012 sebastien bequignon
*/

#include "my.h"

int	signe(char *str, int start)
{
  int	i;
...
void	set_area(char *str, int *start, int *end)
{
  int	i;
...
int	convert(char *str, int start, int end, int positif)
{
  int	cpt;
  int	to_ret;
  int	new_nb;
